...
WLAN_CFG_OVERRIDE_qca6390 := CONFIG_FEATURE_COEX=y CONFIG_QCACLD_FEATURE_BTC_CHAIN_MODE=y CONFIG_IPA3=y CONFIG_IPA_OFFLOAD=y CONFIG_WDI3_IPA_OVER_GSI=y CONFIG_ENABLE_SMMU_S1_TRANSLATION=y
WLAN_CFG_OVERRIDE_qcn7605 := CONFIG_FEATURE_COEX=y CONFIG_QCACLD_FEATURE_BTC_CHAIN_MODE=y CONFIG_FW_THERMAL_THROTTLE=y CONFIG_TARGET_11D_SCAN=y CONFIG_REMOVE_PKT_LOG=n CONFIG_WDI_EVENT_ENABLE=y CONFIG_PKTLOG_LEGACY=y CONFIG_PKTLOG_HAS_SPECIFIC_DATA=y
