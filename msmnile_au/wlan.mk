...
TARGET_WLAN_CHIP += qca6390_cnss2 qca6490_cnss2
endif
...
WLAN_CFG_OVERRIDE_qca6174 := CONFIG_AR6320_SUPPORT=y CONFIG_WLAN_DISABLE_EXPORT_SYMBOL=y
WLAN_CFG_OVERRIDE_qca6390 := CONFIG_FEATURE_COEX=y CONFIG_QCACLD_FEATURE_BTC_CHAIN_MODE=y CONFIG_WLAN_DISABLE_EXPORT_SYMBOL=y
WLAN_CFG_OVERRIDE_qcn7605 := CONFIG_FEATURE_COEX=y CONFIG_QCACLD_FEATURE_BTC_CHAIN_MODE=y CONFIG_WLAN_DISABLE_EXPORT_SYMBOL=y CONFIG_GET_DRIVER_MODE=y
WLAN_CFG_OVERRIDE_qca6490 := CONFIG_FEATURE_COEX=y CONFIG_QCACLD_FEATURE_BTC_CHAIN_MODE=y CONFIG_WLAN_DISABLE_EXPORT_SYMBOL=y

WLAN_KBUILD_OPTIONS_qca6490 := CONFIG_CNSS_QCA6490=y

ifeq ($(strip $(TARGET_SUPPORT_DUAL_WLAN)),true)
WLAN_CFG_OVERRIDE_qca6390_cnss2 := MULTI_IF_NAME=cnss0 CONFIG_WLAN_DISABLE_EXPORT_SYMBOL=y CONFIG_FEATURE_COEX=y CONFIG_QCACLD_FEATURE_BTC_CHAIN_MODE=y
WLAN_CFG_OVERRIDE_qca6490_cnss2 := MULTI_IF_NAME=cnss0 CONFIG_WLAN_DISABLE_EXPORT_SYMBOL=y CONFIG_FEATURE_COEX=y CONFIG_QCACLD_FEATURE_BTC_CHAIN_MODE=y

WLAN_KBUILD_OPTIONS_qca6490_cnss2 := CONFIG_CNSS_QCA6490=y

WIFI_HAL_INTERFACE_COMBINATIONS += ,{{{STA}, 1}, {{AP}, 3}, {{P2P}, 1}}
endif
