...
TARGET_WLAN_CHIP += qca6390_cnss2
endif
...
ifeq ($(strip $(TARGET_SUPPORT_DUAL_WLAN)),true)
WLAN_PLATFORM_KBUILD_OPTIONS += CONFIG_CNSS_SUPPORT_DUAL_DEV=y
endif
...
ifeq ($(strip $(TARGET_SUPPORT_DUAL_WLAN)),true)
WLAN_CFG_OVERRIDE_common_cnss2 := CONFIG_FEATURE_COEX=y CONFIG_QCACLD_FEATURE_BTC_CHAIN_MODE=y CONFIG_SHUTDOWN_WLAN_IN_SYSTEM_SUSPEND=y CONFIG_WLAN_DISABLE_EXPORT_SYMBOL=y
